<template>
  <div v-if="visible" ref="opening" class="opening" role="dialog" aria-label="照安心首頁開場動畫">
    ...
    <button class="opening__skip" type="button" @click="finish">skip</button>
  </div>
</template>
