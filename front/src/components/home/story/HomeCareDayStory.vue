...
.trust-profile{position:relative;display:flex;flex:0 0 calc(100%/var(--visible-count) - 16px);min-width:0;min-height:430px;height:auto;margin-inline:8px;padding:28px 26px 24px;flex-direction:column;overflow:hidden;background:rgba(255,253,251,.94);border:1px solid rgba(110,87,80,.12);border-radius:18px;box-shadow:0 6px 18px rgba(73,56,51,.045),0 18px 42px rgba(73,56,51,.055);transition:transform .32s cubic-bezier(.22,1,.36,1),box-shadow .32s ease,border-color .32s ease,background .32s ease}
.trust-profile::before{content:'';position:absolute;top:0;right:22px;left:22px;height:2px;background:linear-gradient(90deg,transparent,rgba(235,144,121,.52),rgba(200,86,24,.34),transparent);opacity:.65}
.trust-profile__header{display:flex;align-items:flex-start;justify-content:space-between;gap:18px}.trust-profile__header small{display:block;color:rgba(110,87,80,.74);font-size:.68rem;font-weight:700;letter-spacing:.13em;line-height:1.4}.trust-profile__header h4{margin:11px 0 0;color:var(--ink);font-family:'Kaiti TC','Songti TC',serif;font-size:clamp(1.5rem,1.45vw,1.85rem);font-weight:700;line-height:1.35;letter-spacing:.035em}.trust-profile__verified{display:inline-flex;align-items:center;justify-content:center;gap:5px;flex:0 0 auto;min-height:28px;padding:5px 9px;border:1px solid rgba(79,114,100,.11);border-radius:999px;background:rgba(79,114,100,.085);color:#426456;font-size:.72rem;font-weight:800;line-height:1;white-space:nowrap}.trust-profile__verified svg{stroke-width:1.9}
...
.trust-profile__link{display:flex;align-items:center;justify-content:space-between;gap:12px;width:100%;min-height:42px;margin-top:auto;padding:10px 14px;border:1px solid #9d5b39;border-radius:11px;background:#985738;color:#fffdfb;font-size:.82rem;font-weight:750;line-height:1;text-decoration:none;box-shadow:0 4px 10px rgba(110,65,42,.1);transition:background .22s ease,transform .22s ease,box-shadow .22s ease}.trust-profile__link svg,.scene05-trust__all svg{flex:0 0 auto;transition:transform .22s ease}.trust-profile__link:active{transform:translateY(0);background:#713e2c;box-shadow:0 2px 7px rgba(110,65,42,.12)}
...
@media(hover:hover) and (pointer:fine){.trust-profile:hover{transform:translateY(-6px);background:rgba(255,253,251,.99);border-color:rgba(200,86,24,.18);box-shadow:0 10px 26px rgba(73,56,51,.065),0 24px 54px rgba(73,56,51,.1)}.trust-profile__link:hover{background:#7e452f;box-shadow:0 6px 15px rgba(110,65,42,.16);transform:translateY(-1px)}.trust-profile__link:hover svg,.scene05-trust__all:hover svg{transform:translateX(3px)}.scene05-trust__all:hover{transform:translateY(-2px);background:#b84916;box-shadow:0 11px 24px rgba(200,86,24,.19)}.trust-carousel__arrow:not(:disabled):hover{color:var(--persimmon);border-color:rgba(200,86,24,.24);box-shadow:0 10px 28px rgba(73,56,51,.11)}}
