...
.scene05-trust{position:relative;width:min(1320px,calc(100vw - 96px));max-width:none!important;margin:clamp(150px,21vh,220px) auto 0;padding:24px 28px 28px;color:var(--ink);background:linear-gradient(135deg,rgba(255,253,251,.91),rgba(255,249,245,.78));border:1px solid rgba(255,255,255,.72);border-radius:28px;box-shadow:0 20px 55px rgba(73,56,51,.12);backdrop-filter:blur(12px);-webkit-backdrop-filter:blur(12px)}
.scene05-trust__intro{position:relative;z-index:2;display:grid;grid-template-columns:minmax(260px,.9fr) minmax(320px,1.1fr);align-items:end;gap:24px 48px;max-width:none;margin:0 8px 24px}.scene05-trust__eyebrow{grid-column:1;margin:0 0 6px;color:#c85618;font-size:.76rem;font-weight:800;letter-spacing:.16em}.scene05-trust__intro h3{grid-column:1;margin:0;font-family:'Kaiti TC','Songti TC',serif;font-size:clamp(1.55rem,2.1vw,2.35rem);font-weight:700;line-height:1.35;letter-spacing:.02em}.scene05-trust__intro>p:last-child{grid-column:2;grid-row:1/3;margin:0;color:#6e5750;font-size:.92rem;line-height:1.75}
...
.trust-profile{position:relative;display:flex;flex:0 0 calc(100%/var(--visible-count) - 18px);min-width:0;min-height:390px;height:auto;margin-inline:9px;padding:24px 24px 20px;flex-direction:column;overflow:hidden;background:rgba(255,253,251,.96);border:1px solid rgba(110,87,80,.11);border-radius:22px;box-shadow:0 8px 24px rgba(94,66,52,.075);transition:transform .32s cubic-bezier(.22,1,.36,1),box-shadow .32s ease,border-color .32s ease,background .32s ease}
...
.scene05-trust__all{display:inline-flex;align-items:center;justify-content:center;gap:10px;width:max-content;min-height:52px;margin:40px auto 0;padding:0 26px;border:1px solid var(--persimmon);border-radius:999px;background:var(--persimmon);color:#fffdfb;font-size:.94rem;font-weight:800;text-decoration:none;box-shadow:0 7px 18px rgba(200,86,24,.14);transition:transform .24s ease,box-shadow .24s ease,background .24s ease}.trust-profile__link:focus-visible,.scene05-trust__all:focus-visible,.trust-carousel__arrow:focus-visible,.trust-carousel__dot:focus-visible{outline:3px solid rgba(200,86,24,.24);outline-offset:3px}
.trust-carousel__arrow{position:absolute;z-index:4;top:50%;display:grid;place-items:center;width:52px;height:52px;padding:0;border:1px solid rgba(110,87,80,.14);border-radius:50%;background:rgba(255,253,251,.96);color:var(--chestnut);box-shadow:0 8px 22px rgba(73,56,51,.07);backdrop-filter:blur(8px);-webkit-backdrop-filter:blur(8px);cursor:pointer;transform:translateY(-50%);transition:transform .25s ease,opacity .25s ease,background .25s ease,border-color .25s ease,box-shadow .25s ease,color .25s ease}.trust-carousel__arrow--prev{left:-68px}.trust-carousel__arrow--next{right:-68px}.trust-carousel__arrow:disabled{opacity:.28;box-shadow:none;cursor:default}.trust-carousel__dots{display:flex;align-items:center;justify-content:center;gap:0;margin-top:28px}.trust-carousel__dot{position:relative;width:44px;height:44px;margin-inline:-13.5px;padding:0;border:0;background:transparent;cursor:pointer}.trust-carousel__dot::before{content:'';position:absolute;left:50%;top:50%;width:7px;height:7px;border-radius:999px;background:rgba(110,87,80,.2);transform:translate(-50%,-50%);transition:width .28s ease,background .28s ease}.trust-carousel__dot.is-active::before{width:24px;background:var(--persimmon)}
...
@media(hover:hover) and (pointer:fine){.trust-profile:hover{transform:translateY(-5px);background:rgba(255,253,251,.98);border-color:rgba(200,86,24,.19);box-shadow:0 18px 38px rgba(94,66,52,.12)}.trust-profile__link:hover{background:#ae5728;box-shadow:0 7px 16px rgba(151,77,34,.2);transform:translateY(-1px)}.trust-profile__link:hover svg,.scene05-trust__all:hover svg{transform:translateX(3px)}.scene05-trust__all:hover{transform:translateY(-2px);background:#b84916;box-shadow:0 11px 24px rgba(200,86,24,.19)}.trust-carousel__arrow:not(:disabled):hover{color:var(--persimmon);border-color:rgba(200,86,24,.24);box-shadow:0 10px 28px rgba(73,56,51,.11)}}
...
@media(max-width:999px){.scene05-trust{width:calc(100vw - 48px);margin:120px auto 0;padding:24px}.scene05-trust__intro{grid-template-columns:1fr;gap:8px;margin-bottom:22px}.scene05-trust__intro>p:last-child{grid-column:1;grid-row:auto}.trust-carousel--loading .trust-carousel__track{--visible-count:2}.trust-carousel__arrow--prev{left:-14px}.trust-carousel__arrow--next{right:-14px}}
@media(max-width:599px){.scene05-trust{width:100%;margin:26px 0 0;padding:22px 12px 18px;border-radius:20px;background:#fff9f5;box-shadow:none;backdrop-filter:none;-webkit-backdrop-filter:none}.scene05-trust__intro{display:block;margin:0 8px 22px}.scene05-trust__intro h3{font-size:clamp(25px,7vw,32px)}.scene05-trust__intro>p:last-child{margin-top:12px}.trust-carousel{padding:0 4px}.trust-carousel--loading .trust-carousel__track{--visible-count:1}.trust-carousel .trust-profile{flex-basis:calc(100% - 16px);min-height:auto;padding:23px 20px 20px;border-radius:22px;box-shadow:0 8px 24px rgba(73,56,51,.075)}.trust-profile__header h4{font-size:1.55rem}.trust-profile__metrics{margin-top:20px;padding:17px 0}.trust-profile__link{min-height:46px;margin-top:22px;font-size:.88rem}.trust-carousel__arrow{top:auto;bottom:-67px;width:44px;height:44px}.trust-carousel__arrow--prev{left:calc(50% - 78px)}.trust-carousel__arrow--next{right:calc(50% - 78px)}.scene05-trust__all{min-height:50px;margin-top:54px;padding-inline:22px}}
@media(min-width:600px) and (max-width:1099px){.scene06-calculator{max-width:620px;padding:24px;border-radius:22px}}
