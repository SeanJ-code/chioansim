...
<style scoped>
.home-hero{position:relative;isolation:isolate;min-height:88dvh;display:grid;grid-template-columns:minmax(22rem,.8fr) 1.2fr;align-items:center;gap:clamp(2rem,5vw,7rem);overflow:hidden;padding:clamp(4rem,8vh,7rem) max(clamp(1.5rem,5vw,6rem),calc((100vw - 1440px)/2));color:var(--ink)}
