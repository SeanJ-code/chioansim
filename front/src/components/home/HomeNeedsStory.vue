<template>
  ...
  >
    ...
    >
      ...
      >
        <div class="needs-scene__asset" :data-asset-slot="slide.asset" role="img" :aria-label="`${slide.title}場景插畫素材待提供`">
