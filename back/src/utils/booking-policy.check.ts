...
assert.equal(isCancellationRefundEligible('ACCEPTED', new Date('2026-08-15T09:00:00+08:00'), now), true)
assert.equal(isCancellationRefundEligible('ACCEPTED', new Date('2026-08-15T08:59:59+08:00'), now), false)
assert.equal(isCancellationRefundEligible('PENDING', new Date('2026-08-12T10:00:00+08:00'), now), true)
