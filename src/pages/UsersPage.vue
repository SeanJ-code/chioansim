          ...
          <div class="feature-grid">
            <article v-for="feature in features" :key="feature.title" class="feature-card">
              <header :class="feature.tone">
                ...
                <q-badge v-if="feature.badge" rounded :label="feature.title === '預約與照護進度' ? `${activeBookings.length} 筆進行中` : feature.badge" class="feature-badge" />
              </header>
...
onMounted(async () => {
  await Promise.all([loadRecipients(), loadBookings()]);
  liveSync.start(async () => { await Promise.all([loadRecipients(), loadBookings()]); });
